...
def main(_argv):
    ...
    while True:
        ...
        while firstFrame: 
            def click_event(event,x,y,flags,param):
                ...
                if event == cv2.EVENT_LBUTTONDOWN:
                    pts.append((x,y))
                    cv2.circle(frame_1, center = (x,y),radius=5, color=(0,0,255), thickness=-1)
                    strXY = str(x) + " " + str(y)
                    font = cv2.FONT_HERSHEY_SIMPLEX
                    cv2.putText(frame_1, strXY,(x,y), font, 0.5,(255,255,0),2 )  
        ...
        a,b,c,d,e,f,g,h = [209, 1040],[331, 197],[1124,197],[1907,850],[0,0],[1920,0],[1920,1080],[0,1080]
        # e,f,g,h = [0,0],[1920,0],[1920,1080],[0,1080]
        external_poly = [np.array([e,b,c,f]),
                        np.array([f,c,d,g]),
                        np.array([g,d,a,h]),
                        np.array([h,a,b,e])]
